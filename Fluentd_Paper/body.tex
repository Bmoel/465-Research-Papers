...
\quad \quad To start, in general \say{it is known that Logstash consumes more memory than Fluentd}[3]. Due to this Fluentd is a better option to deploy with if a machine is
